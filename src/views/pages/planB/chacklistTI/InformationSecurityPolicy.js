...
import {information} from '../../../../utils/checklistQuestions'
...
const Information = () => {
  ...
  return (
    <CForm style={{marginBottom:'30px'}}>
        <CRow>
            <h2 className="text-black">CHECKLIST – Política de Segurança da Informação </h2>
        </CRow>
        <CCard>
            <CCardBody className="text-black">
            {information.map((question, index) => (
                <div key={index}>
